...
## About Me
Cтудент 2 курса МАИ, института №3 МАИ — Системы управления, информатика и электроэнергетика, параллельно прохожу обучение в Школе 21 от Сбера и на различных курсах. Программированием увлекаюсь со старших классов, начинал с верстки сайтов, в данный момент увлекаюсь разработкой на `Python` и `С/С++`. Не боюсь сложностей, после опыта программирования на чистом `С`, никакие трудности не пугают)
...
* _Stepic:_ __"Поколение Python: курс для продвинутых"__
